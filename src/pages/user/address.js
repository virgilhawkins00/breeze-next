...
const Address = () => {
    return (
        <div className="flex flex-col items-center justify-center">
            <Head>
                <title>AddressBook - theBootStore</title>
            ...
            <div className="container w-full p-4 px-4 lg:px-10 mt-10">
                <Row className="flex flex-col xl:flex-row">
                    <Col span={24} xl={14} className="p-4">
                        <h1 className="font-bold text-5xl uppercase">Address Book</h1>
                        <p className="mb-4">Add your delivery address here.</p>
                        <div className="border inline-block p-4">
                            <h1>Add</h1>
                        </div>
                    </Col>
